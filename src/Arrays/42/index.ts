type IProp = [number, number, number][];
type SingleType = IProp[0][0];

const selectionSort = (arr: IProp): IProp => {
    for (let i = 0; i < arr.length - 1; i++) {
        let lowest: SingleType | undefined;
...
function maximumCpuLoad(arr: IProp): SingleType {
